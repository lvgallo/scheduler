...
storiesOf("Appointment", module)
  ...
  .add("Show", () => (<Show student="Lucy Lee" interviewer={3} onEdit={action("onEdit")} onDelete={action("onDelete")} />))
  ...
  .add("Create", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={action("cancel")} />)
  .add("Edit", () => (<Form student="Lucy Lee" interviewer={3} interviewers={interviewers} onSave={action("onSave")} onCancel={action("cancel")} />))
